...
| `substrate-slice` | a 2D ecosystem slice: agents hover over a band of frames and each turn strike a chord — pulling a different connected configuration (subgraph) |
