# RAGE: Frame-Semantic Graph Construction for Knowledge Substrates

**Julian Fleck**
Draft outline v2 · June 2026
...
| #   | Content                                                    | Purpose                   |
| --- | ---------------------------------------------------------- | ------------------------- |
| 1   | The same document as chunks, entities, frames              | Motivate the contribution |
| 2   | Frame anatomy: concrete instance with typed slots          | Define the primitive      |
| 3   | Two axes of composition: multi-scale tree + semantic roles | Key architectural move    |
| 4   | Extraction pipeline: document through five stages          | Technical core            |
| 5   | Homoiconicity: frame types and operations as frames        | Meta-capability           |
...
4. **Scope of self-bootstrapping claims**: The registry is dynamic in the implementation. How much space does this deserve — a full section or a subsection?
5. **Positioning vs systems like RAPTOR**: RAPTOR also builds recursive tree structures, but by recursive summarization — lossy compression. Frame graphs compose recursively while preserving typed relationships. Is the distinction clear enough as stated?
6. **Frame typology vs Minsky's levels**: Minsky (1974) orders frames by scale — surface syntactic, surface semantic, thematic, narrative. Our nine registry categories grew bottom-up from extraction practice. Should they be mapped onto Minsky's levels? A clean mapping would strengthen the theoretical grounding and might clarify the relationship between the structural and semantic composition axes.
